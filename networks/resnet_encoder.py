...
class UpSampleBN(nn.Module):
    def __init__(self, skip_input, output_features):
        ...
        self.vssblock = VSSBlock(hidden_dim = output_features, drop_path = 0.1, attn_drop_rate = 0.0, d_state = 16, layer = 1)

...
def evaluate(opt):
    ...
    if opt.ext_disp_to_eval is None:
        ...
        with torch.no_grad():
            for data in dataloader:
                ...
                print(f"Inference time: {batch_time:.2f} ms")
        ...
        avg_inference_time = total_inference / num_batches
        print(f"Average inference time per batch: {avg_inference_time:.4f} ms")
        save_dir = "/home/eval/saved_pred"
    ...
    for i in range(pred_disps.shape[0]):
        ...
        #error_path = "/home/depth_eval/error_map/error_{:06d}.png".format(i)
